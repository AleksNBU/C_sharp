...
// Кнопка ОК в двух вариантах, формирование строки добавления нового сотрудника 
        private void button1_Click(object sender, EventArgs e)
        {
            if (p2 == 1)
            {
                GlobalData.querySQL = "INSERT INTO Table1 (Tab,F,I,O,Bithday,Otdel,Dolzhn,Tel,NameComp,Email,Foto) VALUES('" + txtBox1.Text + "','" + txtBox2.Text +
                                    "','" + txtBox3.Text + "','" + txtBox4.Text + "','" + dateTimePicker1.Value.ToShortDateString() + "','" + txtBox6.Text +
                                    "','" + txtBox7.Text + "','" + txtBox8.Text + "','" + Comp + "','" + email + "',@MyImg)";
                GlobalData.prizn = 1;
                ActiveForm.Close();
            }
