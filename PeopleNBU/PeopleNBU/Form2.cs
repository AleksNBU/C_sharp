//==============================================================================================
// Форма добавления сведений о сотруднике
//==============================================================================================
using System;
...
//==============================================================================================
// Если отсутствует фотография сотрудника
...
//==============================================================================================
// Инициализация перегрузок Новых контролов 
...
//==============================================================================================
// Проверка ввода в текст-боксы
        void tb_KeyPress(object sender, KeyPressEventArgs e)
        {
            TextBox t = sender as TextBox;
            string c = e.KeyChar.ToString();
            if (!Regex.Match(c, @"[а-яА-ЯґҐіІїЇєЄ'\-\e\r\b\cC\cX\cV]").Success)
             {
                e.Handled = true;
...
//==============================================================================================        
// Кнопка ОК в двух вариантах, формирование строки добавления нового сотрудника 
        private void button1_Click(object sender, EventArgs e)
        {
            if (p2 == 1)
            {
                GlobalData.querySQL = "INSERT INTO Table1 (Tab,F,I,O,Bithday,Otdel,Dolzhn,Tel,NameComp,Email,Foto,Adress,BIRTHPLACE,Passport,IPN) VALUES('" + txtBox1.Text.Replace("'", "''") + "','" + txtBox2.Text.Replace("'", "''") +
                                    "','" + txtBox3.Text.Replace("'", "''") + "','" + txtBox4.Text + "','" + dateTimePicker1.Value.ToShortDateString() + "','" + txtBox6.Text +
                                    "','" + txtBox7.Text + "','" + txtBox8.Text + "','" + Comp + "','" + email + "',@MyImg,'" + txtBox12.Text + "','" + txtBox13.Text + "','" + txtBox14.Text + "','" + txtBox15.Text + "')";
                GlobalData.prizn = 1;
                ActiveForm.Close();
            }
